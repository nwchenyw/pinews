...
namespace piNews
{
  public partial class choosepaymode : System.Web.UI.Page
  {
	...
	protected void pay_Btn1_Click(object sender, EventArgs e)
	{
	  ...
	  if ( invoice1.Checked == true && string.IsNullOrWhiteSpace(Invoice_carrier.Text) == false )
	  {
        ...
        string url = string.Format(@"https://n.gomypay.asia/ShuntClass.aspx?Send_Type=0&Pay_Mode_No=2&CustomerId=69696686&Order_No={0}&Amount={1}&TransCode=00&Buyer_Name={2}&Buyer_Telm={3}&Buyer_Mail={4}&Buyer_Memo={5}&TransMode=1&Return_url=http://pinews.asia/paycheck.aspx", Order_No, price, Buyer_Name, Buyer_Telm, Buyer_Mail, Buyer_Memo);		  
	...
	protected void pay_Btn2_Click(object sender, EventArgs e)
	{
	  ...
	  if ( invoice1.Checked == true && string.IsNullOrWhiteSpace(Invoice_carrier.Text) == false )
	  {
        ...
        string url = string.Format(@"https://n.gomypay.asia/ShuntClass.aspx?Send_Type=4&Pay_Mode_No=2&CustomerId=69696686&Order_No={0}&Amount={1}&Buyer_Name={2}&Buyer_Telm={3}&Buyer_Mail={4}&Buyer_Memo={5}&TransMode=1&Return_url=http://pinews.asia/paycheck.aspx&Callback_Url=http://pinews.asia/urlcallback.aspx", Order_No, price, Buyer_Name, Buyer_Telm, Buyer_Mail, Buyer_Memo);		  
        Response.Redirect(url);
	  }
	  else if ( invoice2.Checked == true && string.IsNullOrWhiteSpace(Invoice_carrier.Text) == false )
	  {
	    ...
	    string url = string.Format(@"https://n.gomypay.asia/ShuntClass.aspx?Send_Type=4&Pay_Mode_No=2&CustomerId=69696686&Order_No={0}&Amount={1}&Buyer_Name={2}&Buyer_Telm={3}&Buyer_Mail={4}&Buyer_Memo={5}&Return_url=http://pinews.asia/paycheck.aspx&Callback_Url=http://pinews.asia/urlcallback.aspx", Order_No, price, Buyer_Name, Buyer_Telm, Buyer_Mail, Buyer_Memo );		  
        Response.Redirect(url);
      }
	  else if ( invoice3.Checked == true && string.IsNullOrWhiteSpace(Invoice_carrier.Text) == false )
	  {
	...
	protected void pay_Btn3_Click(object sender, EventArgs e)
	{
	  if ( invoice1.Checked == true && string.IsNullOrWhiteSpace(Invoice_carrier.Text) == false )
	  {
			...
			{
				string StoreType = "0";
                string url = string.Format(@"https://n.gomypay.asia/ShuntClass.aspx?Send_Type=6&Pay_Mode_No=2&CustomerId=69696686&Order_No={0}&Amount={1}&StoreType={2}&Buyer_Name={3}&Buyer_Telm={4}&Buyer_Mail={5}&TransMode=1&Buyer_Memo={6}&Return_url=http://pinews.asia/paycheck.aspx&Callback_Url=http://pinews.asia/urlcallback.aspx", Order_No, price, StoreType, Buyer_Name, Buyer_Telm, Buyer_Mail, Buyer_Memo);
				Response.Redirect(url);
			}
