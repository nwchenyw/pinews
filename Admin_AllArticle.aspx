<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeFile="Admin_AllArticle.aspx.cs" Inherits="piNews.Admin_AllArticle" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <style>
    ...
    .ui.disabled.tagged.dropdown {
      padding: .22619048em .35714286em .22619048em;
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="ui inverted segment">
    <div class="ui inverted breadcrumb">
      ...
      <div class="active section">文章總覽</div>
    </div>
  </div>
  <div class="ui segment" style="margin-bottom: 2rem;">
    <%--<h2>拍粉文章審核</h2>
    <div class="ui divider"></div>
    <asp:GridView ID="GridView1" runat="server" CssClass="ui unstackable celled table" AllowPaging="true" PageSize="5" GridLines="None" CellSpacing="5" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" OnPreRender="GridView1_PreRender" OnRowEditing="GridView1_RowEditing">
      <Columns>
        <asp:BoundField DataField="Title" HeaderText="標題" ReadOnly="true" SortExpression="Title"></asp:BoundField>
        <asp:TemplateField HeaderText="分類">
          <ItemTemplate>
            <div class="ui multiple disabled compact tagged dropdown">
          ...
          <EditItemTemplate>
            <div class="ui multiple selection dropdown">
              ...
              <div class="menu">
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:PiNewsConStr %>' SelectCommand="SELECT * FROM [Recommendation]"></asp:SqlDataSource>
              </div>
            </div>
          </EditItemTemplate>
        </asp:TemplateField>
    ...
    <asp:LinkButton ID="LinkButton3" CssClass="ui button" OnClick="LinkButton3_Click" runat="server">全部文章</asp:LinkButton>

    <h2>會員文章總覽</h2>
    <div class="ui divider"></div>
    <asp:GridView ID="GridView2" CssClass="ui unstackable celled table" runat="server" GridLines="None" CellSpacing="5" AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="Id,User_Id" DataSourceID="SqlDataSource2" OnRowCreated="GridView2_RowCreated" OnPreRender="GridView2_PreRender" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowEditing="GridView2_RowEditing" OnRowUpdating="GridView2_RowUpdating" OnSelectedIndexChanging="GridView2_SelectedIndexChanging" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
      <Columns>
        <asp:BoundField DataField="Title" HeaderText="標題" ReadOnly="true" SortExpression="Title"></asp:BoundField>
        <asp:TemplateField HeaderText="分類">
          <ItemTemplate>
          ...
          <ItemTemplate>
            <div class="ui multiple disabled tagged dropdown">
              ...
              <div class="menu">
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:PiNewsConStr %>' SelectCommand="SELECT * FROM [Recommendation] WHERE (([Art_Grouping] = @Art_Grouping) OR ([Art_Grouping] IS NULL))">
                  <SelectParameters>
                    <asp:Parameter DefaultValue="all_article" Name="Art_Grouping" Type="String"></asp:Parameter>
                  </SelectParameters>
                </asp:SqlDataSource>
              </div>
            </div>
        ...
        <asp:TemplateField HeaderText="關鍵字">
          <ItemTemplate>
            <div class="ui multiple disabled tagged dropdown">
              <asp:HiddenField ID="keyword_HF" runat="server" Value='<%# HttpUtility.HtmlDecode(Eval("Keyword").Equals(DBNull.Value) ? "":Eval("Keyword").ToString()) %>' />
              <%--<i class="dropdown icon"></i>--%>
              <div class="default text">Keyword</div>
              <div class="menu">
                <asp:Repeater ID="Keyword_R" runat="server" DataSourceID="SqlDataSource6">
                  <ItemTemplate>
                    <div class="item" data-value='<%# Eval("keyword") %>'><%# Eval("keyword") %></div>
                  </ItemTemplate>
                </asp:Repeater>
                <asp:SqlDataSource runat="server" ID="SqlDataSource6" ConnectionString='<%$ ConnectionStrings:PiNewsConStr %>' SelectCommand="SELECT TOP 20 kw.Item AS keyword
...
group by kw.Item"></asp:SqlDataSource>
        ...
        <asp:BoundField DataField="DateTime" HeaderText="上傳時間" ReadOnly="true" SortExpression="DateTime"></asp:BoundField>
        <asp:TemplateField HeaderText="上架">
          <ItemTemplate>
            <%# Eval("Status").Equals(1) ? "<i class='ui green check icon'></i>":"<i class='ui red times icon'></i>" %>
          </ItemTemplate>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:PiNewsConStr %>' SelectCommand="SELECT Title, Front_Img_Id, Keyword, Category, DateTime, Status, Author, Recommand_Category, Description, Id, User_Id FROM Article ORDER BY DateTime DESC" DeleteCommand="DELETE FROM [Article] WHERE [Id] = @Id" UpdateCommand="UPDATE [Article] SET [Category] = @Category, [Status] = @Status, [Recommand_Category] = @Recommand_Category WHERE [Id] = @Id">
      <DeleteParameters>
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="Id,Author,Author_Email" DataSourceID="SqlDataSource5" OnPreRender="FormView1_PreRender" OnItemUpdating="FormView1_ItemUpdating">
      <EditItemTemplate>
        <div id="article_detail" class="ui fullscreen overlay modal">
          ...
          <div class="scrolling content">
            <div class="ui form text container">
              <div class="field">
                <label>首圖</label>
                <asp:FileUpload ID="front_IU" runat="server" />
                <img class="ui lazy centered image" data-src='Image.aspx?ID=<%# Eval("Front_Img_Id") %>' />
              </div>
              <div class="field">
                <label>標題</label>
                <asp:TextBox ID="Title_TB" runat="server" Text='<%# Bind("Title") %>'></asp:TextBox>
              ...
              <div class="field">
                ...
                <div class="ui multiple selection search dropdown">
                  <asp:HiddenField ID="Keywords_HF" runat="server" Value='<%# Eval("keyword") %>' />
                  <i class="dropdown icon"></i>
                  <div class="default text">Keyword</div>
                  <div class="menu">
...
group by kw.Item"></asp:SqlDataSource>
              ...
              <div class="field">
                <label>是否上架</label>
                <asp:CheckBox Checked='<%# Eval("Status").Equals(1) %>' CssClass="ui toggle checkbox" Text=" " runat="server" ID="StatusCheckBox" />
              </div>
              ...
              <i class="keyboard icons" style="margin-left: .6em;">
                ...
                <div class="ui newading modal">
                  ...
                  <div class="scrolling content">
                    ...
                    <div class="ui bottom attached active tab cards segment" data-tab="first" style="display: flex;margin: 0 auto;">
  ...
  <div class="ui notify tiny modal">
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource5" ConnectionString='<%$ ConnectionStrings:PiNewsConStr %>' SelectCommand="SELECT a.Id, a.Title, a.[Content], a.Front_Img_Id, a.Category, a.Keyword, a.Description,
...
FROM Article AS a WHERE (a.Id = @Id)"
      UpdateCommand="Update Article set Title = @title, Description = @desc, Content = @Content, keyword = @kw, Category = @cat, Relate_Img = @rImg, status = @s, Active_Time = @atime, inActive_Time = @inatime where Id = @Id">
      <SelectParameters>
      ...
      <UpdateParameters>
        ...
        <asp:Parameter Name="kw" />
        <asp:Parameter Name="cat"></asp:Parameter>
        <asp:Parameter Name="rImg"></asp:Parameter>
        <asp:Parameter Name="s"></asp:Parameter>
        <asp:Parameter Name="atime"></asp:Parameter>
        <asp:Parameter Name="inatime"></asp:Parameter>
        <asp:ControlParameter ControlID="GridView2" PropertyName="SelectedValue" Name="Id"></asp:ControlParameter>
      </UpdateParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:PiNewsConStr %>' SelectCommand="SELECT Title, Category, Format(DateTime, 'yyyy/MM/dd tthh:mm') AS DateTime, Status, Recommand_Category, a.Id, Front_Img_Id, count(ul.Id) as cnt 
FROM [Article] a left join Member m on a.User_Id = m.Id LEFT JOIN UserLog ul on ul.Modify_Id = a.Id and ul.Modify_Table = 'Article' 
and ul.Modify_Action = 'View' WHERE m.IsAdmin = 0 GROUP BY TItle,Category,DateTime,Status,Recommand_Category,a.Id,Front_Img_Id order by DateTime Desc"></asp:SqlDataSource>
  </div>
  ...
  <script>
    ...
    $('.ui.disabled.dropdown').dropdown({ allowAdditions: true });
    function ui_rander() {
        ...
        if (checkFileSize(file[0])) {
          ...
          img.onload = function () {
            if (this.width / this.height != 16 / 9) {
              ...
              //$(this).removeAttr('src');
            } else if (this.width > 800 || this.height > 450) {
