...
namespace piNews
{
  public partial class Testpaycheck : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		if ( Request.QueryString["Send_Type"] == "0" && Request.QueryString["result"] == "1")
		{
			...
			if( MD5_32code(needMD5) == Request.QueryString["str_check"].ToString() )
			{
			    ...
			    if (!isPaymented)
                {
                        ...
                        string url = "http://test.gomypay.asia/invoice/GUI2/API/Invoice_addup_new.asp";
		...
		if ( Request.QueryString["Send_Type"] == "0" && Request.QueryString["result"] == "0")
		{
			...
			string url = string.Format(@"https://n.gomypay.asia/TestShuntClass.aspx?Send_Type=0&Pay_Mode_No=2&CustomerId=53229980&Order_No={0}&Amount={1}&TransCode=00&Buyer_Name={2}&Buyer_Telm={3}&Buyer_Mail={4}&Buyer_Memo={5}&Return_url=http://pinews.asia/Testpaycheck.aspx", Order_No, price, Buyer_Name, Buyer_Telm, Buyer_Mail, Buyer_Memo);
