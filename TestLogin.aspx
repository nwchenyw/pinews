<%@ Page Title="" Language="C#" MasterPageFile="ClientPage.Master" AutoEventWireup="true" CodeFile="TestLogin.aspx.cs" Inherits="piNews.TestLogin" %>
    ...
    <div class="event">
      ...
      <div class="content">
        <div class="ui breadcrumb">
          ...
          <div class="active section">拍粉/網記登入</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="ui stackable two column padded grid">
      ...
      <div class="yellow column">
        <div class="ui basic segment">
          <h2>加入拍粉</h2>
          <h3 class="ui black header">免費加入拍粉即刻：</h3>
          <ul class="ui large list">
            <li class="item"><span class="ui black text">訂閱拍新聞</span></li>
            <li class="item"><span class="ui black text">追蹤喜愛拍網記</span></li>
            <li class="item"><span class="ui black text">分享最愛網記新聞</span></li>
            <li class="item"><span class="ui black text">掌握第一手新資訊</span></li>
            <li class="item"><span class="ui black text">回覆喜愛的拍新聞內容</span></li>
            <li class="item"><span class="ui black text">線上投稿(拍新聞有最終上刊權)</span></li>
          </ul>

          <div class="eight wide flex field" style="margin: 0;">
            <a class="ui inverted blue button left floated " href="/Register.aspx">立即加入拍粉</a>
            <a class="ui inverted blue button right floated" href="/TestAdmin_Register.aspx">立即加入網記</a>
          </div>
        </div>
      </div>
